...
func GetDorks() []Dork {
	return []Dork{
		...
		{Pattern: "filename:.env OPENAI_API_KEY", Priority: PriorityHigh, Category: "AI", Description: "OpenAI API key"},

		// AI / LLM provider keys
		{Pattern: "sk-ant-", Priority: PriorityHigh, Category: "AI", Description: "Anthropic (Claude) API key"},
		{Pattern: "filename:.env ANTHROPIC_API_KEY", Priority: PriorityHigh, Category: "AI", Description: "Anthropic API key in .env"},
		{Pattern: "sk-proj-", Priority: PriorityHigh, Category: "AI", Description: "OpenAI project API key"},
		{Pattern: "AIzaSy", Priority: PriorityHigh, Category: "AI", Description: "Google API key (Gemini/Cloud)"},
		{Pattern: "filename:.env GEMINI_API_KEY", Priority: PriorityHigh, Category: "AI", Description: "Google Gemini API key"},
		{Pattern: "filename:.env GOOGLE_API_KEY", Priority: PriorityHigh, Category: "AI", Description: "Google API key in .env"},
		{Pattern: "hf_", Priority: PriorityHigh, Category: "AI", Description: "Hugging Face access token"},
		{Pattern: "filename:.env HUGGINGFACE_API_KEY", Priority: PriorityHigh, Category: "AI", Description: "Hugging Face API key in .env"},
		{Pattern: "gsk_", Priority: PriorityHigh, Category: "AI", Description: "Groq API key"},
		{Pattern: "filename:.env GROQ_API_KEY", Priority: PriorityHigh, Category: "AI", Description: "Groq API key in .env"},
		{Pattern: "r8_", Priority: PriorityHigh, Category: "AI", Description: "Replicate API token"},
		{Pattern: "filename:.env REPLICATE_API_TOKEN", Priority: PriorityHigh, Category: "AI", Description: "Replicate token in .env"},
		{Pattern: "pplx-", Priority: PriorityHigh, Category: "AI", Description: "Perplexity API key"},
		{Pattern: "filename:.env PERPLEXITY_API_KEY", Priority: PriorityHigh, Category: "AI", Description: "Perplexity API key in .env"},
		{Pattern: "xai-", Priority: PriorityHigh, Category: "AI", Description: "xAI (Grok) API key"},
		{Pattern: "filename:.env XAI_API_KEY", Priority: PriorityHigh, Category: "AI", Description: "xAI API key in .env"},
		{Pattern: "sk-or-v1-", Priority: PriorityHigh, Category: "AI", Description: "OpenRouter API key"},
		{Pattern: "filename:.env OPENROUTER_API_KEY", Priority: PriorityHigh, Category: "AI", Description: "OpenRouter API key in .env"},
		{Pattern: "filename:.env MISTRAL_API_KEY", Priority: PriorityHigh, Category: "AI", Description: "Mistral AI API key"},
		{Pattern: "filename:.env COHERE_API_KEY", Priority: PriorityHigh, Category: "AI", Description: "Cohere API key"},
		{Pattern: "filename:.env DEEPSEEK_API_KEY", Priority: PriorityHigh, Category: "AI", Description: "DeepSeek API key"},
		{Pattern: "filename:.env TOGETHER_API_KEY", Priority: PriorityHigh, Category: "AI", Description: "Together AI API key"},
		{Pattern: "filename:.env AZURE_OPENAI_API_KEY", Priority: PriorityHigh, Category: "AI", Description: "Azure OpenAI API key"},
		{Pattern: "filename:.env ELEVENLABS_API_KEY", Priority: PriorityHigh, Category: "AI", Description: "ElevenLabs API key"},
		{Pattern: "filename:.env STABILITY_API_KEY", Priority: PriorityHigh, Category: "AI", Description: "Stability AI API key"},
		{Pattern: "filename:.env LANGCHAIN_API_KEY", Priority: PriorityMedium, Category: "AI", Description: "LangChain/LangSmith API key"},
		{Pattern: "filename:.env PINECONE_API_KEY", Priority: PriorityMedium, Category: "AI", Description: "Pinecone vector DB key"},

		// Modern high-signal token prefixes
		{Pattern: "github_pat_", Priority: PriorityHigh, Category: "GitHub", Description: "GitHub fine-grained PAT"},
		{Pattern: "glpat-", Priority: PriorityHigh, Category: "GitLab", Description: "GitLab personal access token"},
		{Pattern: "AKIA", Priority: PriorityHigh, Category: "AWS", Description: "AWS access key ID prefix"},
		{Pattern: "sk_live_", Priority: PriorityHigh, Category: "Payment", Description: "Stripe live secret key"},
		{Pattern: "filename:.env SUPABASE_SERVICE_ROLE_KEY", Priority: PriorityHigh, Category: "Supabase", Description: "Supabase service role key"},
		{Pattern: "xoxb-", Priority: PriorityMedium, Category: "Slack", Description: "Slack bot token"},
		{Pattern: "xoxp-", Priority: PriorityMedium, Category: "Slack", Description: "Slack user token"},
